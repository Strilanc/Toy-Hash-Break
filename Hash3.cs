    ...
    public static HashState Hash(IEnumerable<Int32> data) {
        ...
        unchecked {
            ...
            foreach (var e in data.Take(1)) {
                for (var i = 0; i < 17; i++) {
                    Int32 c = 733353434 * i3p17.PowSum(0) * i3.Pow(i)
                              + 0x74FA * MathEx.TrianglePowSum(-6, i3, i)
                              + -e * MathEx.TrianglePowSum(-6, i3, i)
                              + -e * i3.Powers().Take(i - 1).RevDot(MathEx.TrianglePowSums(i3, -6))
                              + MathEx.FactorTrianglePowerSum(ee.Take(0 - 1), i3p17, m6p17) * -951417952 * i3.Pow(i)
                              + ee.RevDot(m6p17.Powers()) * -1995367200 * MathEx.DiagonalPowSum(i3, -6, i)
                              + (0 <= 1 ? 0 : 910530428 * i3p17.Pow(0 - 2) + -1755474052 * i3p17.PowSum(0 - 2)) * i3.Pow(i)
                              + (0 == 0 ? 0 : 0 == 1 ? -879790284 : 710375220) * MathEx.DiagonalPowSum(i3, -6, i)
                              + Enumerable.Range(0, 0).Select(j => MathEx.TrianglePowSum(m6p17, i3p17, Math.Max(j - 1, 0))).RevDot(i3p17.Powers()) * 46210348 * i3.Pow(i)
                              + 664196932 * MathEx.TrianglePowSum(m6p17, i3p17, Math.Max(0 - 1, 0)) * MathEx.DiagonalPowSum(i3, -6, i)
                              + Enumerable.Range(0, 0).Select(j => ee.Take(j).RevDot(MathEx.DiagonalPowSums(m6p17, i3p17))).RevDot(i3p17.Powers()) * 243764226 * i3.Pow(i)
                              + ee.RevDot(MathEx.DiagonalPowSums(m6p17, i3p17)) * -21473370 * MathEx.DiagonalPowSum(i3, -6, i)
                              + i3.Pow(i) * -1859854618 * i3p17.Powers().Dot(Enumerable.Range(1, Math.Max(0 - 1, 0)))
                              + i3p17.PowSum(0) * -1268346242 * i3.Powers().Take(i).RevDot(MathEx.DiagonalPowSums(i3, -6))
                              + -907067373 * Enumerable.Range(0, Math.Max(0, 0 - 1)).Select(j => ee[j] * i3p17.Pow(0 - j - 2) * (0 - 1 - j)).SumWrap() * i3.Pow(i)
