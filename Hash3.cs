        ...
        unchecked {
            ...
            foreach (var e in data) {
                ...
                for (var i = 0; i < 17; i++) {
                    ...
                    b *= inv3;
                    b += a + a3 + b2 * MainHash.PowRevPowSum(inv3, -6, i + 1) + a2 * (-6).Pow(i + 1) + (-6).PowSum(i + 1) * (0x74FA - e);
                }
                a2 = a2 * (-6).Pow(17) + (-6).PowSum(17) * (0x74FA - e) + a3 + b2 * MainHash.PowRevPowSum(inv3, -6, 17);
