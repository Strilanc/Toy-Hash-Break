    ...
    public static HashState Hash(IEnumerable<Int32> data) {
        ...
        unchecked {
            ...
            foreach (var e in data) {
                for (var i = 0; i < 17; i++) {
                    Int32 c = inv3.Pow(17).PowSum(dn) * 643801250 * inv3.Pow(i) + 0x74FA * MainHash.PowSumRevPowSum(-6, inv3, i);
                    a *= -6;
                    a += b + c + b4;
            ...
            return new HashState(a + a2 + a3, b + b2 + inv3.Pow(17).PowSum(dn) * 643801250 + b4);
        }
    }
}
