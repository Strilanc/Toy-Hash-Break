...
public static class MainHash {
    ...
    public static void Main() {
        unchecked {
            ...
            var rName1 = 8.Range().Select(e => Hash4.Break(nameHash1, e)).FirstOrDefault(e => e != null);
            Console.WriteLine("n1: " + Decode(rName1));
            var rName2 = 8.Range().Select(e => Hash4.Break(nameHash2, e)).FirstOrDefault(e => e != null);
            Console.WriteLine("n2: " + Decode(rName2));
            var rName3 = 8.Range().Select(e => Hash4.Break(nameHash3, e)).FirstOrDefault(e => e != null);
            Console.WriteLine("n3: " + Decode(rName3));
            var rPass = 8.Range().Select(e => Hash4.Break(passwordHash, e, Hash(Encode("<+")))).FirstOrDefault(e => e != null);
